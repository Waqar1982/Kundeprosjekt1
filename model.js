...
data: {
    ...
    dogs: [ //Kan starte med ett bilde
        ...
        { id: 2, name: 'testnavn2', race: '', age: '', size: '', favorittmat: '', rating: 3, ratings: 34, pictures: [] },
        { id: 3, name: 'testnavn3', race: '', age: '', size: '', favorittmat: '', rating: 3.5, ratings: 41, picture: 'dogpictures/dog3.avif' },
        { id: 4, name: 'testnavn4', race: '', age: '', size: '', favorittmat: '', rating: 5, ratings: 28, pictures: [] },
        { id: 5, name: 'testnavn5', race: '', age: '', size: '', favorittmat: '', rating: 4.5, ratings: 33, picture: 'dogpictures/dog5.avif' },
        { id: 6, name: 'testnavn6', race: '', age: '', size: '', favorittmat: '', rating: 4, ratings: 52, pictures: [] },
        { id: 7, name: 'testnavn7', race: '', age: '', size: '', favorittmat: '', rating: 3, ratings: 34, pictures: [] },
        { id: 8, name: 'testnavn8', race: '', age: '', size: '', favorittmat: '', rating: 3.5, ratings: 41, pictures: [] },
        ...
        { id: 13, name: 'testnavn12', race: '', age: '', size: '', favorittmat: '', rating: 3.5, ratings: 41, pictures: [] },
        { id: 14, name: 'testnavn13', race: '', age: '', size: '', favorittmat: '', rating: 5, ratings: 28, pictures: [] },
        { id: 15, name: 'testnavn14', race: '', age: '', size: '', favorittmat: '', rating: 4.5, ratings: 33, pictures: [] },
        { id: 16, name: 'testnavn15', race: '', age: '', size: '', favorittmat: '', rating: 4.5, ratings: 33, pictures: [] },
    ],
